...
const logo = (width=270) => {
  ...
  return `<a href="${links.site}" target="_blank" aria-label="ТехнологИИ Права" style="display:inline-block;text-decoration:none"><table role="presentation" cellpadding="0" cellspacing="0" style="width:auto;max-width:100%"><tr><td nowrap style="${type};color:#29e0e5;border-bottom:3px solid #29e0e5;padding-bottom:2px">ТЕХНОЛОГ</td><td nowrap style="${type};color:#ff3aa7;border-bottom:3px solid #ff3aa7;padding-bottom:2px">ИИ</td><td nowrap style="${type};color:#29e0e5;border-bottom:3px solid #29e0e5;padding-bottom:2px">&nbsp;ПРАВА</td></tr></table></a>`;
};
