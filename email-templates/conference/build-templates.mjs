...
const logo = (width=270) => {
  ...
  const segment = (text, color) => `<td nowrap valign="top" style="padding:0"><span style="${type};display:block;white-space:nowrap;color:${color};padding:0 0 6px;border-bottom:3px solid ${color}">${text}</span></td>`;
  return `<a href="${links.site}" target="_blank" aria-label="ТехнологИИ Права" style="display:inline-block;text-decoration:none"><table role="presentation" cellpadding="0" cellspacing="0" style="width:auto;max-width:100%;border-collapse:separate;border-spacing:0"><tr>${segment('ТЕХНОЛОГ','#29e0e5')}${segment('ИИ','#ff3aa7')}${segment('&nbsp;ПРАВА','#29e0e5')}</tr></table></a>`;
};
const legal = (dark=false, align='center') => `<tr><td class="px" style="padding-top:22px;padding-bottom:30px;color:${dark?'#8495aa':'#75869a'};font-size:11px;line-height:17px;text-align:${align}"><b style="color:${dark?'#b8c5d5':'#53667c'}">© 2026 ООО «ТехнологИИ Права»</b><br>Москва · 25–26 сентября 2026 · БЦ «Красные Ворота»<br><a href="mailto:info@tech-pravo.ru" style="color:${dark?'#5de1e6':'#087f8c'}">info@tech-pravo.ru</a>&nbsp;&nbsp;·&nbsp;&nbsp;<a href="${links.site}" target="_blank" style="color:${dark?'#5de1e6':'#087f8c'}">tech-pravo.ru/conference</a></td></tr>`;
