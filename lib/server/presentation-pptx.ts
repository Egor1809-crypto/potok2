...
function slideShapes(project: PresentationProjectRecord, slide: PresentationSlide, image?: ImageEntry) {
  ...
  if (slide.layout === "title") {
    ...
    shapes.push(textBox(id++, "Маркер", x, 6.62 * EMU, 2.2 * EMU, 0.3 * EMU, [{ text: "MAILFLOW PRESENTATIONS", options: { color: muted, fontSize: 9, bold: true } }]));
...
function packageEntries(project: PresentationProjectRecord, images: Array<ImageEntry | undefined>) {
  ...
  xmlFile("docProps/core.xml", `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><dc:title>${xml(project.name)}</dc:title><dc:creator>MAILFLOW</dc:creator><cp:lastModifiedBy>MAILFLOW</cp:lastModifiedBy><dcterms:created xsi:type="dcterms:W3CDTF">${now}</dcterms:created><dcterms:modified xsi:type="dcterms:W3CDTF">${now}</dcterms:modified></cp:coreProperties>`);
  xmlFile("docProps/app.xml", `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>MAILFLOW</Application><PresentationFormat>On-screen Show (16:9)</PresentationFormat><Slides>${project.slides.length}</Slides><Notes>0</Notes><HiddenSlides>0</HiddenSlides><MMClips>0</MMClips><ScaleCrop>false</ScaleCrop><Company>MAILFLOW</Company><AppVersion>1.0</AppVersion></Properties>`);
  ...
  xmlFile("ppt/theme/theme1.xml", `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="MAILFLOW"><a:themeElements><a:clrScheme name="MAILFLOW"><a:dk1><a:srgbClr val="${hex(project.textColor)}"/></a:dk1><a:lt1><a:srgbClr val="${hex(project.backgroundColor)}"/></a:lt1><a:dk2><a:srgbClr val="${hex(project.textColor)}"/></a:dk2><a:lt2><a:srgbClr val="${hex(project.backgroundColor)}"/></a:lt2><a:accent1><a:srgbClr val="${hex(project.accentColor)}"/></a:accent1><a:accent2><a:srgbClr val="C7A6FF"/></a:accent2><a:accent3><a:srgbClr val="36C7B5"/></a:accent3><a:accent4><a:srgbClr val="F05A3C"/></a:accent4><a:accent5><a:srgbClr val="5D76CB"/></a:accent5><a:accent6><a:srgbClr val="C08A3E"/></a:accent6><a:hlink><a:srgbClr val="6558E8"/></a:hlink><a:folHlink><a:srgbClr val="8E5EB6"/></a:folHlink></a:clrScheme><a:fontScheme name="MAILFLOW"><a:majorFont><a:latin typeface="Arial"/><a:ea typeface=""/><a:cs typeface="Arial"/></a:majorFont><a:minorFont><a:latin typeface="Arial"/><a:ea typeface=""/><a:cs typeface="Arial"/></a:minorFont></a:fontScheme><a:fmtScheme name="MAILFLOW"><a:fillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="accent1"/></a:solidFill><a:solidFill><a:schemeClr val="accent2"/></a:solidFill></a:fillStyleLst><a:lnStyleLst><a:ln w="6350"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/></a:ln><a:ln w="12700"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/></a:ln><a:ln w="19050"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/></a:ln></a:lnStyleLst><a:effectStyleLst><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst/></a:effectStyle></a:effectStyleLst><a:bgFillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="lt1"/></a:solidFill><a:solidFill><a:schemeClr val="lt2"/></a:solidFill></a:bgFillStyleLst></a:fmtScheme></a:themeElements></a:theme>`);
