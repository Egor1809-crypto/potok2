...
const styleDirections: Record<ImageStudioStyle, string> = {
  ...
  cinematic: "Кинематографический кадр с продуманной глубиной, направленным светом, благородной цветокоррекцией и естественной атмосферой без рекламной постановочности.",
  architectural: "Архитектурная визуализация с точной перспективой, выразительными материалами, спокойным дневным светом и чистой композицией уровня дизайн-журнала.",
  botanical: "Современная ботаническая арт-дирекция: натуральные растения, органические формы, тактильные поверхности, мягкий свет и сдержанная природная палитра.",
  technical: "Точная техническая иллюстрация: ясные взаимосвязи, чистая геометрия, чертёжная логика и визуальная иерархия без мелкого текста и интерфейсного шума.",
  luxury: "Тихая премиальная арт-дирекция: дорогие материалы, контролируемый свет, минимальная палитра, тонкие детали и много негативного пространства без демонстративного блеска.",
  "paper-cut": "Многослойная иллюстрация из вырезанной бумаги: аккуратные края, мягкие тени, выразительная глубина и авторская композиция без детской стилизации.",
};
