...
const PRIVATE_TEAM_SECRETS = new Set(["UNISENDER_API_KEY", "VK_WORKSPACE_SMTP_PASSWORD", "VK_WORKSPACE_SMTP_PASSWORD_2", "VK_WORKSPACE_SMTP_EMAIL", "VK_WORKSPACE_SMTP_EMAIL_2", "VK_COMMUNITY_ACCESS_TOKEN", "TELEGRAM_BOT_TOKEN", "TELEGRAM_BOT_TOKEN_2", "COMMUNICATION_WEBHOOK_SECRET"]);
