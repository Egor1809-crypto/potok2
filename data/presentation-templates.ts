...
export const presentationThemes: PresentationTheme[] = [
  ...
  },
  {
    id: "linen",
    name: "Лён",
    description: "Тёплая тканевая фактура, оливковый акцент и спокойная editorial-сетка",
    accentColor: "#7A7052",
  ...
  },
  {
    id: "graphite",
    name: "Графит",
    description: "Сдержанный тёмный фон, холодный свет и строгая информационная иерархия",
    accentColor: "#8FB7FF",
  ...
  },
  {
    id: "nordic",
    name: "Север",
    description: "Холодный белый, древесный акцент и функциональная скандинавская простота",
    accentColor: "#B45B3E",
  ...
  },
  {
    id: "emerald",
    name: "Изумруд",
    description: "Глубокая зелень, светлая бумага и уверенная премиальная контрастность",
    accentColor: "#0B755E",
  ...
  },
  {
    id: "signal",
    name: "Сигнал",
    description: "Почти белое поле, угольный текст и один яркий оранжевый маркер",
    accentColor: "#FF4E1F",
  ...
  },
  {
    id: "museum",
    name: "Музей",
    description: "Галерейный белый, бордовый акцент и большие поля для изображений",
    accentColor: "#7E2434",
  ...
  },
  {
    id: "paper",
    name: "Бумага",
    description: "Мягкий молочный фон, чернильная типографика и редакционная простота",
    accentColor: "#345A72",
  ...
  },
  {
    id: "plum",
    name: "Слива",
    description: "Глубокий сливовый акцент, пудровые поверхности и мягкая драматургия",
    accentColor: "#713653",
...
const styleTemplateSpecs: StyleTemplateSpec[] = [
  ...
  {
    slug: "linen-hospitality",
    name: "Концепция гостеприимства",
    description: "Тактильная история отеля или ресторана: атмосфера, сервис, пространство и опыт гостя.",
    useCase: "Гостеприимство",
    themeId: "linen",
    eyebrow: "HOSPITALITY CONCEPT",
  },
  {
    slug: "linen-craft",
    name: "Бренд ремесленной мастерской",
    description: "Спокойная подача происхождения, материалов, процесса и характера продукта.",
    useCase: "Брендинг",
    themeId: "linen",
    eyebrow: "CRAFT STORY",
  },
  {
    slug: "linen-retreat",
    name: "Программа ретрита",
    description: "Мягкая история пространства, практик, расписания и ожидаемого состояния участника.",
    useCase: "Wellness",
    themeId: "linen",
  ...
  {
    slug: "graphite-ai",
    name: "AI-платформа · Graphite",
    description: "Тёмный технологичный питч: проблема, архитектура решения, доказательства и внедрение.",
    useCase: "Технологии",
    themeId: "graphite",
    eyebrow: "AI PLATFORM",
  },
  {
    slug: "graphite-security",
    name: "Аудит киберрисков",
    description: "Управленческий обзор угроз, приоритетов защиты и контрольных точек программы.",
    useCase: "Безопасность",
    themeId: "graphite",
    eyebrow: "CYBER RISK REVIEW",
  },
  {
    slug: "graphite-board",
    name: "Материалы для совета директоров",
    description: "Сжатая управленческая логика: сигнал, последствия, варианты и решение.",
    useCase: "Управление",
    themeId: "graphite",
    eyebrow: "BOARD MEMO",
  },
  {
    ...
    name: "Коллекция мебели",
    description: "Функциональная скандинавская подача формы, материала и сценариев использования.",
    useCase: "Дизайн",
    themeId: "nordic",
  ...
  {
    slug: "nordic-service",
    name: "Сервисная концепция",
    description: "Чистая история пути клиента, принципов сервиса и критериев качества.",
    useCase: "Сервис",
    themeId: "nordic",
    eyebrow: "SERVICE DESIGN",
  },
  {
    slug: "nordic-research",
    name: "Качественное исследование",
    description: "Воздушная презентация наблюдений, паттернов поведения и продуктовых выводов.",
    useCase: "Исследования",
    themeId: "nordic",
  ...
  },
  {
    ...
    description: "Уверенная структура тезиса, риска, портфеля и контрольных показателей.",
    useCase: "Финансы",
    themeId: "emerald",
  ...
  },
  {
    ...
    name: "Инвестиционный объект",
    description: "Премиальная презентация локации, концепции, экономики и потенциала актива.",
    useCase: "Недвижимость",
    themeId: "emerald",
    eyebrow: "PROPERTY INVESTMENT",
  },
  {
    slug: "emerald-health",
    name: "Стратегия клиники",
    description: "Доказательная история качества помощи, пациентского пути и развития сервиса.",
    useCase: "Медицина",
    themeId: "emerald",
    eyebrow: "CARE STRATEGY",
  },
  {
    slug: "signal-launch",
    name: "Смелый запуск продукта",
    description: "Контрастный анонс изменения, главной ценности, доказательства и первого действия.",
    useCase: "Продукт",
    themeId: "signal",
    eyebrow: "LAUNCH SIGNAL",
  },
  {
    slug: "signal-manifesto",
    name: "Манифест изменений",
    description: "Сильная последовательность напряжения, позиции, принципов и призыва к действию.",
    useCase: "Коммуникации",
    themeId: "signal",
    eyebrow: "CHANGE MANIFESTO",
  },
  {
    slug: "signal-growth",
    name: "План роста",
    description: "Динамичная управленческая история от ограничения к ставкам и следующему циклу.",
    useCase: "Стратегия",
    themeId: "signal",
    eyebrow: "GROWTH PLAN",
  },
  {
    ...
    name: "Кураторская концепция выставки",
    description: "Галерейная подача идеи, маршрута зрителя, ключевых работ и программы.",
    useCase: "Культура",
    themeId: "museum",
    eyebrow: "CURATORIAL CONCEPT",
  },
  {
    slug: "museum-portfolio",
    name: "Портфолио архитектора",
    description: "Минималистичная серия проектов с контекстом, решениями и визуальными доказательствами.",
    useCase: "Портфолио",
    themeId: "museum",
  ...
  },
  {
    ...
    description: "Редакционная история коллекции, силуэтов, материалов и визуального мира бренда.",
    useCase: "Мода",
    themeId: "museum",
    eyebrow: "COLLECTION LOOKBOOK",
  },
  {
    slug: "paper-thesis",
    name: "Защита исследования",
    description: "Академичная, но живая логика: вопрос, метод, данные, вывод и значение работы.",
    useCase: "Образование",
    themeId: "paper",
    eyebrow: "RESEARCH DEFENSE",
  },
  {
    slug: "paper-policy",
    name: "Аналитическая записка",
    description: "Редакционная презентация проблемы, фактов, вариантов и рекомендации.",
    useCase: "Аналитика",
    themeId: "paper",
    eyebrow: "POLICY NOTE",
  },
  {
    ...
    description: "Понятный учебный маршрут: задача, модель, упражнение, разбор и перенос в работу.",
    useCase: "Обучение",
    themeId: "paper",
  ...
  {
    slug: "plum-beauty",
    name: "Косметический бренд",
    description: "Мягкая премиальная история формулы, ритуала, доказательств и коллекции.",
    useCase: "Beauty",
    themeId: "plum",
  ...
  {
    slug: "plum-community",
    name: "Женское сообщество",
    description: "Тёплая презентация ценностей, форматов участия, историй и приглашения.",
    useCase: "Сообщество",
    themeId: "plum",
  ...
  {
    slug: "plum-wedding",
    name: "Концепция частного события",
    description: "Эмоциональная, но собранная история атмосферы, программы и деталей события.",
    useCase: "События",
    themeId: "plum",
