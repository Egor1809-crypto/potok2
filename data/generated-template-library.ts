...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    blocks: (t, p) => [logo(p, t, "PERSONAL NOTE"), { id: `${p}-heading`, type: "heading", content: "{{first_name}}, есть конкретная идея для вашей команды", alignment: "left", textColor: t.text, fontFamily: "Georgia", fontWeight: 400, fontSize: 38 }, { id: `${p}-text`, type: "text", content: "Я изучил открытые материалы {{company}} и увидел возможность упростить подготовку клиентских коммуникаций без потери фирменного стиля.", alignment: "left", textColor: t.text, fontSize: 16, lineHeight: 170 }, { id: `${p}-quote`, type: "quote", content: "Предлагаю не презентацию, а короткий разбор одного реального сценария вашей команды.|Егор", alignment: "left", backgroundColor: t.soft, textColor: t.text, borderRadius: 10 }, { id: `${p}-button`, type: "button", content: "Выбрать время", label: "Выбрать время", href: "https://tech-pravo.ru/", alignment: "left", buttonStyle: "soft", textColor: t.accent, borderRadius: 10 }, { id: `${p}-signature`, type: "signature", content: "Егор Сабалин|Основатель MAILFLOW|info@tech-pravo.ru", alignment: "left", textColor: t.text }, footer(p, t)],
  },
  {
