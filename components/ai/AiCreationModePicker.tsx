...
export function AiCreationModePicker({
  ...
  const options = [
    ...
    },
    {
      ...
      description: `ИИ не опирается на готовый макет и самостоятельно режиссирует ${artifact}: структуру, ритм, типографику, изображения и декор.`,
      badge: "Авторская композиция",
    },
  ];
