...
const metrics = [
  { label: "Contacts", value: "24,821", change: "+8.2%", note: "1,894 added", color: "#625cf6" },
  { label: "Campaigns sent", value: "128", change: "+12%", note: "14 this month", color: "#33a3d6" },
  { label: "Delivery rate", value: "98.2%", change: "+1.4%", note: "Above benchmark", color: "#45a36c" },
  { label: "Reply rate", value: "6.4%", change: "+0.8%", note: "328 conversations", color: "#e09742" },
];
