    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Арт-директор", description: "Разбор писем, презентаций и фотографий", href: "/art-director", icon: Gauge, exact: true, keywords: ["аудит", "проверка", "дизайн", "текст", "конверсия"] },
