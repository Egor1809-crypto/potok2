    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Арт-директор писем", description: "Проверка текста, дизайна и конверсии", href: "/templates?director=1", icon: Gauge, exact: true, keywords: ["аудит", "проверка", "дизайн", "текст", "конверсия"] },
