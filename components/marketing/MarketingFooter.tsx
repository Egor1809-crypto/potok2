...
export function MarketingFooter() {
  return <footer id="contacts" className={styles.footer}>
    <div className={styles.footerTop}>
      <div className={styles.footerBrand}><BrandMark href="/" /><p>Хорошая идея заслуживает<br />хорошего воплощения.</p><span>Письма · Презентации · Изображения</span></div>
    ...
    <div className={styles.footerBottom}><span>© {new Date().getFullYear()} Поток</span><span>Создавайте. Дорабатывайте. Делитесь.</span><a href="#main">Наверх ↑</a></div>
  </footer>;
}
