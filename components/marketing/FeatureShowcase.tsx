    ...
    <section id="product" className="overflow-hidden py-24 sm:py-32">
      <div className="container-shell space-y-28 sm:space-y-40">
        <div className="grid items-center gap-12 lg:grid-cols-[.82fr_1.18fr] lg:gap-20">
          <FeatureHeading eyebrow="Контактная база" title="Все деловые связи — в одном месте." copy="Люди, компании, история общения и важные сигналы всегда под рукой. Вы сразу понимаете, к кому обратиться и почему." />
          <div aria-hidden="true" className="rounded-[20px] border border-[#e2e3e9] bg-[#f8f9fb] p-3 shadow-[0_22px_60px_rgba(31,32,52,.09)]">
            <div className="overflow-hidden rounded-[14px] border border-[#e4e5eb] bg-white">
              <div className="flex items-center justify-between border-b border-[#ececf1] px-4 py-3"><div><p className="text-xs font-semibold">Участники конференции</p><p className="text-[10px] text-[#9799a5]">3 921 контакт</p></div><span className="rounded-lg bg-[#625cf6] px-3 py-2 text-[9px] font-semibold text-white">Добавить контакт</span></div>
        ...
        <div id="solutions" className="grid items-center gap-12 lg:grid-cols-[1.16fr_.84fr] lg:gap-20">
          <div className="order-2 rounded-[22px] border border-[#dedfe7] bg-white p-5 shadow-[0_24px_70px_rgba(31,32,52,.1)] lg:order-1">
            <div className="flex items-center justify-between"><div><p className="text-sm font-semibold text-[#242631]">Найдите именно тех, кто вам нужен</p><p className="mt-1 text-[11px] text-[#9698a5]">Все условия должны совпасть</p></div><span className="rounded-lg border border-[#e2e3e9] px-2.5 py-1.5 text-[9px] font-semibold text-[#555765]">Сбросить</span></div>
            ...
            <div className="mt-5 flex flex-col gap-3 rounded-xl border border-[#deddfd] bg-[#f7f6ff] p-4 sm:flex-row sm:items-center sm:justify-between"><div><p className="text-[10px] text-[#77798a]">Аудитория готова</p><p className="text-xl font-semibold tracking-[-.03em] text-[#252632]">843 контакта</p></div><div className="flex gap-2"><span className="rounded-lg border border-[#d9d8f8] bg-white px-3 py-2 text-[10px] font-semibold text-[#5752c5]">Сохранить сегмент</span><Link href="/campaigns/new" className="flex items-center gap-2 rounded-lg bg-[#625cf6] px-3 py-2 text-[10px] font-semibold text-white">Создать кампанию <ArrowRight size={13} /></Link></div></div>
          </div>
        ...
        <div id="templates" className="grid items-center gap-12 lg:grid-cols-[.78fr_1.22fr] lg:gap-20">
          ...
          <div aria-hidden="true" className="overflow-hidden rounded-[22px] border border-[#dfe0e7] bg-[#edeef3] shadow-[0_25px_75px_rgba(31,32,52,.12)]">
            <div className="flex h-11 items-center justify-between border-b border-[#dddfe6] bg-white px-4"><div><p className="text-[10px] font-semibold">Приглашение на юридическую конференцию</p><p className="text-[8px] text-[#999ba7]">Только что сохранено</p></div><div className="flex gap-1.5"><span className="rounded-md border border-[#e3e4e9] px-2 py-1.5 text-[8px]">Предпросмотр</span><span className="rounded-md bg-[#625cf6] px-2 py-1.5 text-[8px] font-semibold text-white">Продолжить</span></div></div>
            <div className="grid h-[440px] grid-cols-[72px_1fr] sm:grid-cols-[108px_1fr_132px]">
              ...
              <div className="overflow-hidden p-4 sm:p-7"><div className="mx-auto min-h-[380px] max-w-[330px] bg-white p-8 shadow-sm"><div className="mb-9 text-[8px] font-semibold tracking-[.15em]">АРБИТРА <span className="text-[#625cf6]">ФОРУМ</span></div><p className="text-[9px] font-medium text-[#625cf6]">25–26 СЕНТЯБРЯ · МОСКВА</p><h3 className="mt-3 text-[25px] font-medium leading-[1.08] tracking-[-.04em] text-[#242530]">Вы приглашены.</h3><p className="mt-4 text-[9px] leading-4 text-[#71737f]">Здравствуйте, <span className="rounded bg-[#eeedff] px-1 text-[#5b55d8]">Иван</span>. Два насыщенных дня с лидерами юридической отрасли о будущем технологий и практики.</p><span className="mt-6 inline-flex rounded-md bg-[#242530] px-4 py-2.5 text-[8px] font-semibold text-white">Забронировать место</span><div className="mt-10 border-t border-[#ebebef] pt-4 text-[7px] leading-3 text-[#a0a2ad]">Арбитра Форум · Тверская ул., 18<br />Москва, 125009</div></div></div>
